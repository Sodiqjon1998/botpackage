            ...
            ?>
                <div class="col-12 align-middle">
                    ...
                    <?php
                        ...
                        $chatId = '-1002089884417'; // Guruh identifikatorini o'zgartiring
                        
                        $apiUrl1 = "https://api.telegram.org/bot$token/getChatAdministrators?chat_id=$chatId";
                        $response1 = file_get_contents($apiUrl1);
                        $data1 = json_decode($response1, true);
                        
                        // Administratorlarning ma'lumotlarini ekranga chiqarish
                        $i=0;
                        foreach ($data1['result'] as $admin) {
                            $userId = $admin['user']['id'];
                            $firstName = $admin['user']['first_name'];
                            $lastName = $admin['user']['last_name'];
                            $username = $admin['user']['username'];
                            echo "User ID: $userId, First Name: $firstName, Last Name: $lastName, Username: @$username\n"."<br>";
                        }
                    ?>
                    <hr>
                    <?php
                        ...
                        $response = file_get_contents($apiUrl . "getChatMembers?chat_id=$chatId");
